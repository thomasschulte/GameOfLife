(ns GameOfLife
  (:import [System.Windows.Forms Form TableLayoutPanel Label Button TextBox Panel Timer PaintEventHandler PaintEventArgs AnchorStyles])
  (:import [System.Drawing Size Point Color SolidBrush]))
  ...
  [length]
   (let [form (Form.)
     ...
     (doto pnl-paint
       ...
       (.set_Anchor (Enum/ToObject AnchorStyles 15))
